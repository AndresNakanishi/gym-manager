...
<div class="row">
    <aside class="column">
        <div class="side-nav">
            ...
            <?= $this->Html->link(__('Edit Civil Status'), ['action' => 'edit', $civilStatus->id], ['class' => 'side-nav-item']) ?>
            <?= $this->Form->postLink(__('Delete Civil Status'), ['action' => 'delete', $civilStatus->id], ['confirm' => __('Are you sure you want to delete # {0}?', $civilStatus->id), 'class' => 'side-nav-item']) ?>
            <?= $this->Html->link(__('List Civil Status'), ['action' => 'index'], ['class' => 'side-nav-item']) ?>
            <?= $this->Html->link(__('New Civil Status'), ['action' => 'add'], ['class' => 'side-nav-item']) ?>
        </div>
    </aside>
    <div class="column-responsive column-80">
        <div class="civilStatus view content">
            ...
            <div class="related">
                ...
                <?php if (!empty($civilStatus->users)) : ?>
                <div class="table-responsive">
                    <table>
                        ...
                        <?php foreach ($civilStatus->users as $users) : ?>
                        <tr>
                            <td><?= h($users->id) ?></td>
