...
<div class="row">
    <aside class="column">
        <div class="side-nav">
            ...
            <?= $this->Html->link(__('Edit Blood Type'), ['action' => 'edit', $bloodType->id], ['class' => 'side-nav-item']) ?>
            <?= $this->Form->postLink(__('Delete Blood Type'), ['action' => 'delete', $bloodType->id], ['confirm' => __('Are you sure you want to delete # {0}?', $bloodType->id), 'class' => 'side-nav-item']) ?>
            <?= $this->Html->link(__('List Blood Type'), ['action' => 'index'], ['class' => 'side-nav-item']) ?>
            <?= $this->Html->link(__('New Blood Type'), ['action' => 'add'], ['class' => 'side-nav-item']) ?>
        </div>
    </aside>
    <div class="column-responsive column-80">
        <div class="bloodType view content">
            <h3><?= h($bloodType->id) ?></h3>
            <table>
                <tr>
            ...
            <div class="related">
                ...
                <div class="table-responsive">
                    <table>
                        ...
                        <?php foreach ($bloodType->users as $users) : ?>
                        <tr>
                            <td><?= h($users->id) ?></td>
