            ...
            <div class="col-lg-6 col-sm-6">
                <?= $this->Form->create($user) ?>
                    ...
                    <div class="form-group">
                        ...
                        <div class="radio">
                            <label>
                                <input type="radio" name="smoker" id="smoker1" value="1"> Si
                            </label>
                        </div>
                        <div class="radio">
                            <label>
                                <input type="radio" name="smoker" id="smoker2" value="0" checked> No
                            </label>
                        </div>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <div class="radio">
                            <label>
                                <input type="radio" name="diabetic" id="diabetic1" value="1"> Si
                            </label>
                        </div>
                        <div class="radio">
                            <label>
                                <input type="radio" name="diabetic" id="diabetic2" value="0" checked> No
                            </label>
                        </div>
                    </div>
                    <div class="form-group">
