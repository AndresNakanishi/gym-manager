...
<ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion toggled" id="accordionSidebar">
    ...
    <!-- Sidebar - Brand -->
    <a class="sidebar-brand d-flex align-items-center justify-content-center" href="<?= $this->Url->buildFromPath('Users::dashboard'); ?>">
    ...
    <li class="nav-item">
        <a class="nav-link" href="<?= $this->Url->buildFromPath('Assistance::index'); ?>">
