...
class ProductsFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        '_indexes' => [
            'fk_product_created_by_idx' => ['type' => 'index', 'columns' => ['created_by'], 'length' => []],
            'fk_product_updated_by_idx' => ['type' => 'index', 'columns' => ['updated_by'], 'length' => []],
        ],
        '_constraints' => [
            'primary' => ['type' => 'primary', 'columns' => ['id'], 'length' => []],
            'fk_product_updated_by' => ['type' => 'foreign', 'columns' => ['updated_by'], 'references' => ['users', 'id'], 'update' => 'noAction', 'delete' => 'noAction', 'length' => []],
            'fk_product_created_by' => ['type' => 'foreign', 'columns' => ['created_by'], 'references' => ['users', 'id'], 'update' => 'noAction', 'delete' => 'noAction', 'length' => []],
        ],
        '_options' => [
            'engine' => 'InnoDB',
    ...
    public function init(): void
    {
        $this->records = [
            [
                ...
                'created_by' => 1,
                'updated_by' => 1,
                'created_at' => '2021-01-02 23:45:49',
                'updated_at' => '2021-01-02 23:45:49',
            ],
        ];
        parent::init();
    }
