 ...
 * Memberships Model
 *
 * @property \App\Model\Table\MembershipTypesTable&\Cake\ORM\Association\BelongsTo $MembershipTypes
...
class MembershipsTable extends Table
{
    ...
    {
        $rules->add($rules->existsIn(['membership_type_id'], 'MembershipTypes'), ['errorField' => 'membership_type_id']);
